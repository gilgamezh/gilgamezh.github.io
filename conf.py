...
BLOG_AUTHOR = "GiLgAmEzH"  # (translatable)
...
BLOG_EMAIL = "mail@gilgamezh.me"
BLOG_DESCRIPTION = "Blog personal de Nicol\u00e1s Demarchi."  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - My Fingerprint: {fingerprint}  Powered by         <a href="http://getnikola.com" rel="nofollow">Nikola</a>         {license}'
...
# is in the manual.
COMMENT_SYSTEM_ID = "notodoesmecnico"
...
TWITTER_CARD = {
    ...
    'site': '@gilgamezh',         # twitter nick for the website
    'creator': '@gilgamezh',     # Username for the content creator / author.
}
